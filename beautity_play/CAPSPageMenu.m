...
@property (nonatomic, assign) CGFloat menuScrollViewHeight;
...
- (void)setUpMenuItemView:(CGFloat)menuItemWidth menuScrollViewHeight:(CGFloat)menuScrollViewHeight indicatorHeight:(CGFloat)indicatorHeight separatorPercentageHeight:(CGFloat)separatorPercentageHeight separatorWidth:(CGFloat)separatorWidth separatorRoundEdges:(BOOL)separatorRoundEdges menuItemSeparatorColor:(UIColor *)menuItemSeparatorColor
{
    ...
    _badgeView = [[JSBadgeView alloc] initWithParentView:_titleLabel alignment:JSBadgeViewAlignmentCenterRight];
    ...
    self.menuScrollViewHeight = menuScrollViewHeight;
}
...
//        CGSize titleLabelSize = [text sizeWithFont:_titleLabel.font byHeight:_titleLabel.height];
//        _titleLabel.width = titleLabelSize.width+25;
        _titleLabel.center = CGPointMake(self.menuItemWidth*0.5, self.menuScrollViewHeight*0.5);
    }
}

- (void)setBadgeText:(NSString *)text
{
    _badgeView.badgeText = text;
}
